class Game {
  ...
  start() {
    ...
    var obstacle2Positions = [
      { x: width / 2 - 220, y: height - 2500, image: obstacle2Image },
      { x: width / 2 - 450, y: height - 3300, image: obstacle2Image },
      { x: width / 2 + 280, y: height - 3400, image: obstacle2Image },
     
      { x: width / 2 + 50, y: height - 1800, image: obstacle2Image },
